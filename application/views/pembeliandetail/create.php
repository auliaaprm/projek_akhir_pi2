                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-10 mt-3">
                        ...
                        <form action="<?= base_url('pembeliandetail/simpandetailpembelian'); ?>" method="POST">
                            <input type="hidden" name="pembelian_id" value="<?= $pembelian['pembelian_id'] ?>"> <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="harga_satuan" class="form-control" id="exampleFormControlInput1" placeholder="Harga Satuan" placeholde="harga satuan">
                    </div>
                    <div class="mb-3">
