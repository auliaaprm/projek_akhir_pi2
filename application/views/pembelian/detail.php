            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                            <h4><b>DAFTAR DETAIL PEMBELIAN</b></h4>
                    </div>
                    <hr></hr>
                    <div class="row mt-3">
                        <div class="col-3">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>Rp <?=number_format($pembelian['harga_satuan']); ?></td>
                                    <td>Rp <?=number_format($pembelian['harga_total']); ?></td>

                                    <td>

                                        <a href="<?= base_url('pembeliandetail/hapus/' . $pembelian['pembelian_id'] . '/' . $pembelian['pembelian_detail_id'] . '/' . $pembelian['barang_id']) ?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            }
