        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card" style="width: 30rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="card-body" >
                    <div class="col-md-10 mt-3">
                        <h3> TAMBAH DATA BARANG </h3>
                        <hr></hr>
                        <form class="form" action="<?= base_url('barang/simpanbarang') ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="stok" class="form-control" id="exampleFormControlInput1" placeholder="stok barang">
                            </div>
                            <div class="mb-3">
